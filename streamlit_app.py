...
# --- HALAMAN UTAMA (JIKA SUDAH LOGIN) ---
    ...
    # Inisialisasi status kunci level jika belum ada
    ...
    with tab_materi:
        ...
        with st.expander("Klik di sini untuk melihat Pembahasan"):
            st.write(r"Berdasarkan Hukum Kekekalan Massa: $\text{Massa Fe} + \text{Massa S} = \text{Massa FeS}$")
        ...
        st.text_input("Tulis jawabanmu di sini (contoh: 2 gram):", key="tanya_lavoisier")
        st.write("---")
        ...
        with st.expander("Klik di sini untuk melihat Pembahasan"):
            st.write(r"- Perbandingan $\text{Cu} : \text{S} = 2 : 1$.")
            st.write(r"- Belerang ($\text{S}$) yang tersedia hanya 3 gram. Maka $\text{Cu}$ yang bereaksi = $2 \times 3 = 6\text{ gram}$.")
            st.write(r"- Massa $\text{CuS} = 6\text{g (Cu)} + 3\text{g (S)} = $ **9 gram**. (Tersisa sisa tembaga bermassa 4 gram).")
        ...
        st.text_input("Tulis jawabanmu di sini (contoh: 11 gram):", key="tanya_proust")
        st.write("---")
        ...
        with st.expander("Klik di sini untuk melihat Pembahasan"):
            st.write("- Senyawa I: X = 40%, Y = 60%. Perbandingan X : Y = 1 : 1,5")
            st.write("- Senyawa II: X = 50%, Y = 50%. Perbandingan X : Y = 1 : 1")
            st.write("Jika massa X dibuat sama-sama (1), maka perbandingan massa Y pada Senyawa I : Senyawa II adalah 1,5 : 1 = **3 : 2** (Terbukti berupa bilangan bulat dan sederhana).")
        ...
        st.text_input("Tulis jawabanmu di sini (contoh: 1 : 2):", key="tanya_dalton")
        st.write("---")
        ...
        with st.expander("Klik di sini untuk melihat Pembahasan"):
            st.write(r"Perbandingan koefisien $\text{H}_2 : \text{H}_2\text{O} = 2 : 2 = 1 : 1$. Maka Volume $\text{H}_2\text{O} = $ **6 Liter**.")
        ...
        st.text_input("Tulis jawabanmu di sini (contoh: 5 Liter):", key="tanya_gay")
        st.write("---")
        ...
        with st.expander("Klik di sini untuk melihat Pembahasan"):
            st.write(r"Volume gas berbanding lurus dengan jumlah molekul. Maka molekul $\text{O}_2 = 3 \times (3 \times 10^{22}) = $ **$9 \times 10^{22}$ molekul**.")
    ...
    with tab_kuis:
        ...
        if st.button("Kirim Lembar Jawaban Kuis 📝"):
            ...
            # Pembahasan menggunakan rumus per LaTeX (atas-bawah) yang rapi
            st.latex(r"\text{5. Senyawa I: } Q = \frac{60\%}{40\%} = 1,5 \quad \text{dan Senyawa II: } Q = \frac{50\%}{50\%} = 1")
            st.latex(r"\text{Maka perbandingan massa Q = } 1,5 : 1 = 3 : 2")
            
            st.info("6. **Dalton** (Teori Kelipatan Berganda adalah milik John Dalton)")
            
            st.latex(r"\text{7. Volume } \text{NH}_3 = \frac{\text{Koefisien NH}_3}{\text{Koefisien H}_2} \times \text{Volume H}_2 = \frac{2}{3} \times 9\text{ L} = 6\text{ Liter}")
            
            st.info("8. **Perbandingan Volume** (Bunyi Hukum Gay-Lussac)")
            
            st.latex(r"\text{9. Volume CO}_2 \text{ naik 2 kali lipat } \left(\frac{4\text{ L}}{2\text{ L}}\right)\text{, maka jumlah molekul } = 2 \times 10^{20}")
            
            st.info("10. **Jumlah molekul dan Volume gas** (Inti hipotesis Avogadro)")
